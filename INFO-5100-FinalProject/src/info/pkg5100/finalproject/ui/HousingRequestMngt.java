 ...
 * @author ankit
 */
public class HousingRequestMngt extends javax.swing.JPanel {
	...
	public HousingRequestMngt() {
		initComponents();
	}

    public HousingRequestMngt(JPanel mainWorkJPanel, User currentuser, Organization currentOrganization) throws SQLException {
        initComponents();
    ...
    private void btnAcceptRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptRequestActionPerformed
        try {
            ...
            Logger.getLogger(HousingRequestMngt.class.getName()).log(Level.SEVERE, null, ex);
        }
